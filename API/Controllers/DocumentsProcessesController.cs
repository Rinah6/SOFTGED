...
namespace API.Controllers
{
    ...
    public class DocumentsProcessesController : ControllerBase
    {
        ...
        public async Task<ActionResult> AddNewDocumentValidationCircuit([FromForm] DocumentValidationCircuitToAdd documentValidationCircuitToAdd)
        {
            ...
            }, currentUserId, DocumentStatus.Ongoing);
        ...
        public async Task<ActionResult> ArchiveDocument([FromForm] DocumentToArchive documentToArchive)
        {
            ...
            var document = await _documentService.CreateDocument(documentToArchive.File, documentToArchive.Attachements, documentToArchive.Title, documentToArchive.Object, documentToArchive.Message, Convert.ToBoolean(documentToArchive.RSF), currentUserId, DocumentStatus.Archived);
