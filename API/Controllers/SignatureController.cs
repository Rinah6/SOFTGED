...
namespace API.Controllers
{
    ...
    public class SignatureController : ControllerBase
    {
        ...
        public async Task<ActionResult> SignDocument([FromForm] DocumentToSign documentToSign)
        {
            ...
            var document = await _documentService.CreateDocument(documentToSign.DocumentFile, documentToSign.Attachements, documentToSign.Title, documentToSign.Object, documentToSign.Message, Convert.ToBoolean(documentToSign.RSF), currentUserId, DocumentStatus.Archived);
