...
namespace API.Controllers
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        public async Task<ActionResult> ArchiveDocument([FromForm] SupplierDocumentToAdd supplierDocumentToAdd)
        {
            ...
            var document = await _documentService.CreateDocument(supplierDocumentToAdd.PdfDocument, supplierDocumentToAdd.Attachements, supplierDocumentToAdd.Title, supplierDocumentToAdd.Object, supplierDocumentToAdd.Message, false, currentSupplierId, DocumentStatus.None);
