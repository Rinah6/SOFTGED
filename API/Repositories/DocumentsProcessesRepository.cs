...
namespace API.Repositories
{
    public partial class DocumentsProcessesRepository
    {
        ...
        public async Task AddDocument(DocumentToAdd documentToAdd)
        {
            ...
            using var cmd = new SqlCommand(@"
                INSERT INTO Documents (Id, Filename, OriginalFilename, Url, Title, Object, Message, RSF, Status, SenderId)
                VALUES (@id, @filename, @originalFilename, @url, @title, @object, @message, @RSF, @documentStatus, @senderId);
            ", conn);
        ...
        public async Task AddDocumentValidatorStep(UserStepToAdd userStepToAdd, Guid documentId)
        {
            ...
            using var cmd = new SqlCommand(@"
                INSERT INTO DocumentSteps (Id, StepNumber, ProcessingDuration, Role, Color, DocumentId)
        ...
        public async Task AddDocumentStep(RecipientsStep recipientsStep, Guid documentId)
        {
            ...
            using var cmd = new SqlCommand(@"
                INSERT INTO DocumentSteps (Id, StepNumber, ProcessingDuration, Role, Color, Message, DocumentId)
