...
namespace API.Services
{
    public class DocumentService
    {
        ...
        public async Task<Model.Document?> CreateDocument(IFormFile pdfDocument, List<IFormFile>? attachements, string Title, string Object, string Message, bool RSF, Guid userId, DocumentStatus documentStatus)
        {
        ...
        public async Task<Model.Document> CreateDocument(NewDocumentDetails newDocumentDetails, Guid userId, DocumentStatus documentStatus)
        {
            //try
            //{
